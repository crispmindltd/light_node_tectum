...
const
  ...
  TET_CHAIN_TOTAL_NUMBER_COMMAND_CODE = 101;
  TET_DYN_CHAIN_TOTAL_NUMBER_COMMAND_CODE = 102;
  TET_CHAIN_SYNC_COMMAND_CODE = 103;
  DYN_TET_CHAIN_SYNC_COMMAND_CODE = 104;
  TOKEN_ICO_SYNC_COMMAND_CODE = 105;
  SMARTKEY_SYNC_COMMAND_CODE = 106;
  TOKEN_SYNC_COMMAND_CODE = 107;
